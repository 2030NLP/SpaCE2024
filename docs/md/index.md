...
（1）空间信息实体识别。要求从四个选项中选出文本空间信息的参照物。
...
##### 2.1.1  <span id="task2">空间信息实体识别</span>
...
##### 2.1.2  <span id="task3">空间信息角色识别</span>
...
##### 2.1.3  <span id="task1">空间信息异常识别</span>
...
##### 2.1.5  <span id="task5">空间异形同义识别</span>
