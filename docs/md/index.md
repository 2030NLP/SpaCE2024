# <center>第四届中文空间语义理解评测任务（SpaCE2023）</center>
...
为了评测机器的空间语义理解能力，推进空间范畴的认知计算建模研究，我们于 2021 年开始连续两年举办了中文空间语义理解评测任务（Spatial Cognition Evaluation，简称 SpaCE）。今年，我们继续推出**第四届中文空间语义理解评测（SpaCE2023）**，包含如下 3 个子任务：
...
$$F1=\frac{2×P×R}{P+R}$$ 
$$P=\frac{正确检出字符数}{待检项总字符数}$$
$$R=\frac{正确检出字符数}{参考项总字符数}$$
