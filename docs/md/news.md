...
- `5月 18日` 排行榜上的所有队伍都【必须提交2页以上】的技术报告！没有提交技术报告的队伍，将不会出现在最终榜单上，也不会获奖。技术报告写明技术细节即可。想在CCL报告/被CCL录用的队伍请写【4页以上】的正式评测论文，论文录用不与获奖名次挂钩，考虑学术标准，最终录用0~5篇，精选3篇进行现场汇报。技术报告和评测论文的提交平台为openreview<a href="https://openreview.net/" target="_blank">，未注册的队伍建议使用edu邮箱。
